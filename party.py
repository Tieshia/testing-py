...
def is_mel(name, email):
    ...
    >>> is_mel('Mel Ma', "mel@ubermelon.com")
    True

    >>> is_mel('Mel Melitpolski', "melanie@ubermelon.com")
    True

    >>> is_mel('Tieshia', 'email@address.com')
    False
    """
    print name.lower() + email.lower()
    return re.search(r'mel', name.lower() + email.lower())
    #     return True
    # else:
    #     return False
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'dessert'},{'type': 'dessert'},{'type': 'dessert'},{'type': 'appetizer'}])
    ('dessert', 'appetizer')

    >>> most_and_least_common_type([{'type': 'dessert'},{'type': 'appetizer'},{'type': 'appetizer'},{'type': 'appetizer'}])
    ('appetizer', 'dessert')
